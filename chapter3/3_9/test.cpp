...
利用 gettimeofday 函数，对整个读取过程精确到微秒的计时
    gettimeofday函数用法
     -https://blog.csdn.net/weixin_39589699/article/details/125198785?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522166755147616782428627085%2522%252C%2522scm%2522%253A%252220140713.130102334..%2522%257D&request_id=166755147616782428627085&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~all~top_click~default-2-125198785-null-null.142^v63^control,201^v3^control_2,213^v1^control&utm_term=gettimeofday&spm=1018.2226.3001.4187
*/
